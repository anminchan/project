...
// 코인 합계
function coin_sum($mb_id, $coin, $price, $date, $gubun)
{
    global $config;
    global $g5;
    global $is_admin;
    ...
    $common_query = "";
    $cc = sql_fetch(" select * from {$g5['coin_sum_table']} where mb_id = '$mb_id' and cc_date = '$date' ");
    if (!$cc['mb_id']) {
        // 회원코인
        $mb_coin = $cc['mb_coin'];
        $sum_mb_coin = $mb_coin + $coin;
        ...
        if($gubun=='0'){
            $common_query = "cc_sum0 = '$coin',";
            $common_query .= "cc_sum_price0 = '$price',";
        }elseif ($gubun=='1'){
            $common_query = "cc_sum1 = '$coin',";
            $common_query .= "cc_sum_price1 = '$price',";
        }elseif ($gubun=='2'){
            $common_query = "cc_sum2 = '$coin',";
            $common_query .= "cc_sum_price2 = '$price',";
        }elseif ($gubun=='3'){
            $common_query = "cc_sum3 = '$coin',";
        }elseif ($gubun=='4'){
            $common_query = "cc_sum4 = '$coin',";
        }elseif ($gubun=='5'){
            $common_query = "cc_sum5 = '$coin',";
        }
        ...
        $cc2 = sql_fetch(" select * from {$g5['coin_sum_table']} where mb_id = '$mb_id' order by cc_date desc limit 1 ");

        if($gubun=='0'){
            $common_query = "cc_sum0 = '$coin',";
            $common_query .= "cc_sum_price0 = '$price',";
            if($cc2['cc_sum6'])$common_query = "cc_sum6 = '{$cc2['cc_sum6']}',";
        }elseif ($gubun=='1'){
            $common_query = "cc_sum1 = '$coin',";
            $common_query .= "cc_sum_price1 = '$price',";
            if($cc2['cc_sum6'])$common_query = "cc_sum6 = (cc_sum1+{$cc2['cc_sum6']}),";
        }elseif ($gubun=='2'){
            $common_query = "cc_sum2 = '$coin',";
            $common_query .= "cc_sum_price2 = '$price',";
            if($cc2['cc_sum6'])$common_query = "cc_sum6 = '{$cc2['cc_sum6']}',";
            ...
            $common_query = "cc_sum3 = '$coin',";
            if($cc2['cc_sum6'])$common_query = "cc_sum6 = (cc_sum3+{$cc2['cc_sum6']}),";
        }elseif ($gubun=='4'){
            $common_query = "cc_sum4 = '$coin',";
            if($cc2['cc_sum6'])$common_query = "cc_sum6 = ({$cc2['cc_sum6']}-cc_sum4),";
        }elseif ($gubun=='5'){
            $common_query = "cc_sum5 = '$coin',";
            if($cc2['cc_sum6'])$common_query = "cc_sum6 = ({$cc2['cc_sum6']}-cc_sum5),";
        }
