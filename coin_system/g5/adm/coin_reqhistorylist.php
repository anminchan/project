...
<div class="admin_pg_notice od_test_caution">(주의!) 모든 데이터 조회가 가능합니다.(속도가 느릴 수 있습니다.)</div>
...
<form name="fcoin_reqlist" id="fcoin_reqlist" method="post" onsubmit="return fcoin_reqlist_submit(this);" autocomplete="off">
    ...
    <div class="tbl_head01 tbl_wrap" id="coin_reqhistorylist">
        <table>
            ...
            <tr>
                ...
                <th scope="col"><?php echo subject_sort_link('cr_uptime', $qstr); ?>거래일자</a></th>
            </tr>
            </thead>
            <tbody>
            <?php
...
<script>
    ...
    $("#frmExcel").on("click", function() {
        ...
        location.href = "./coin_reqhistory_excel.php?" + qstr;
    });
</script>
