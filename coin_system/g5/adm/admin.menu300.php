...
$menu['menu300'] = array (
    ...
    array('300904', '판매업체별현황(DB)', G5_ADMIN_URL.'/seller_reqcalculate.php', 'seller_reqcalculate'),
    array('300905', '판매업체별현황(API)', G5_ADMIN_URL.'/seller_reqcalculate_api.php', 'seller_reqcalculate_api'),*/
