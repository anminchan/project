...
<div class="tbl_head01 tbl_wrap">
    ...
    <tr>
        ...
        <th scope="col" rowspan="2" id="mb_list_mng">내역확인</th>
    </tr>
    <tr>
    ...
    <tr class="<?php echo $bg; ?>">
        ...
        <td headers="mb_list_mng" rowspan="2" class="td_mng td_mng_s"><?php echo $s_mod ?></td>
        <td headers="mb_list_mng" rowspan="2" class="td_mng td_mng_s"><?php echo $coin_list ?></td>
    </tr>
    <tr class="<?php echo $bg; ?>">
        ...
        <td headers="mb_list_auth" class="td_mbstat">
            ...
            <input type="hidden" name="<?php echo "mb_level[$i]"; ?>" value="<?php echo $row['mb_level']?>" />
